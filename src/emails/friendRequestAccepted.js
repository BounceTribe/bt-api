      ...
      <mj-container>
        <mj-section>
          <mj-column>
            ...
            <mj-text font-size="16px" color="#777777" font-family="helvetica" padding-bottom="20px">${username} has joined your tribe and wants to hear more of your music.</mj-text>

            <mj-button inner-padding="16px 30px" font-size="15px" font-family="Helvetica, Arial" align="left" background-color="#9075F3" color="white">
              View Profile
            </mj-button>
...
export default function friendRequestAccepted(username){
  return`
    <!doctype html>
                              ...
                              <tbody>
                                <tr>
                                  <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:16px 30px;" align="center" valign="middle" bgcolor="#9075F3">
                                    <p style="text-decoration:none;line-height:100%;background:#9075F3;color:white;font-family:Helvetica, Arial;font-size:15px;font-weight:normal;text-transform:none;margin:0px;">View Profile</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
