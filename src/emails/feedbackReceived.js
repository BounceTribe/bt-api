...
export default function feedbackReceived(handle){
  return`
  <!doctype html>
                          ...
                          <tbody>
                            <tr>
                              <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:16px 30px;" align="center" valign="middle" bgcolor="#9075F3">
                                <p style="text-decoration:none;line-height:100%;background:#9075F3;color:white;font-family:Helvetica, Arial;font-size:15px;font-weight:normal;text-transform:none;margin:0px;">View Feedback</p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
